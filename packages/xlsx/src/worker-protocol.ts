...
export type RenderWorkerRequest =
  ...
  | { type: 'parse'; id: number; data: ArrayBuffer; maxZipEntryBytes?: number; parserResourceLimits?: ParserResourceLimits; useGoogleFonts?: boolean }
  ...
  | { type: 'parseSheet'; id: number; sheetIndex: number; sheetName?: string; maxZipEntryBytes?: number; parserResourceLimits?: ParserResourceLimits }
