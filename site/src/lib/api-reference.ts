  ...
  xlsx: [
    {
      ...
      methods: [
        ...
        { sig: 'getSelectionContext(options?: { maxCells?: number }): XlsxSelectionContext | null', desc: 'Return bounded, serializable selected-cell context for read-only AI/MCP handoff, including formulas and Viewer-formatted display text.' },
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'getSelectionContext(options?: { maxCells?: number }): XlsxSelectionContext | null', desc: 'Return bounded, detached selected-cell context for AI/MCP use.' },
