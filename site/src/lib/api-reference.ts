  ...
  xlsx: [
    {
      ...
      methods: [
        ...
        { sig: 'getSelectionContext(options?: { maxCells?: number; maxTextCharacters?: number }): XlsxSelectionContext | null', desc: 'Return cell-count- and text-bounded serializable context for read-only AI/MCP handoff, including formulas and Viewer-formatted display text.' },
    ...
    },
    {
      ...
      methods: [
        ...
        { sig: 'getSelectionContext(options?: { maxCells?: number; maxTextCharacters?: number }): XlsxSelectionContext | null', desc: 'Return cell-count- and text-bounded detached context for AI/MCP use.' },
