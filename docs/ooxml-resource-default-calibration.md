...
Recorded: 2026-08-01. Scope: Draft PR #1120.

The standard admission policy remains 128 MiB for one inflated archive entry
and 256 MiB for distinct inflated bytes visited in one package session. These
...
128 MiB / 256 MiB is retained because it is simple, gives normal documents
large headroom, and turns the known pathological class into a deterministic
